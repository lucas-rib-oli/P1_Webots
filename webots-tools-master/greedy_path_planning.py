...
def main ():
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument("-r", "--root", type=str, default="/home/lsi/UC3M/Simuladores_de_Robots/P1_Webots/webots-tools-master/assets", help="path to folder map")
    ...
    parser.add_argument("--end_x", type=int, default=14, help="end coordinate x")
    parser.add_argument("--end_y", type=int, default=12, help="end coordinate y")
